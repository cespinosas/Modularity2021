...
nu_rep = params[1]
sdm = 1
xmodb <- read.table(paste0("distbtwnw/", seed, "_modb_", sdm, "k_", nu_rep , "rep_general_set1.txt"), header = TRUE, sep = "\t")
xmoda <- read.table(paste0("distbtwnw/", seed, "_moda_", sdm, "k_", nu_rep , "rep_general_set1.txt"), header = TRUE, sep = "\t")
...
pdf(paste0("distbtwnw/", seed, "_", sdm, "k_", nu_rep , "rep_controls_set1.pdf"),paper='special')
    grid.arrange(pmod, pedges, ptot_phen1, ptot_acphen1, mylegend)
dev.off()

pdf(paste0("distbtwnw/", seed, "_", sdm, "k_", nu_rep , "rep_general_set1.pdf"),paper='special')
    grid.arrange(pnupasos, ptot_phen, ptot_phen2, pfrac_newpht, ptot_acphen, ptot_acphen2, pfrac_newacph, mylegend)
dev.off()


xmodb <- read.table(paste0("distbtwnw/", seed, "_modb_", sdm, "k_", nu_rep , "rep_acphens_set1.txt"), header = TRUE, sep = "\t")
xmoda <- read.table(paste0("distbtwnw/", seed, "_moda_", sdm, "k_", nu_rep , "rep_acphens_set1.txt"), header = TRUE, sep = "\t")
...
pdf(paste0("distbtwnw/", seed, "_", sdm, "k_", nu_rep , "rep_acphens_set1.pdf"),paper='special')
    grid.arrange(ptot_acphens, psim_acphens, pmods_acphens, pacphens_d1, pacphens_m1, pfrac_acphens_d1, pfrac_acphens_m1, mylegend)
dev.off()



xmodb <- read.table(paste0("distbtwnw/", seed, "_modb_", sdm, "k_", nu_rep , "rep_newphen_set1.txt"), header = TRUE, sep = "\t")
xmoda <- read.table(paste0("distbtwnw/", seed, "_moda_", sdm, "k_", nu_rep , "rep_newphen_set1.txt"), header = TRUE, sep = "\t")
...
pdf(paste0("distbtwnw/", seed, "_", sdm, "k_", nu_rep, "rep_newpht_set1.pdf"),paper='special')
...
pdf(paste0("distbtwnw/", seed, "_", sdm, "k_", nu_rep, "rep_newacph_set1.pdf"),paper='special')
