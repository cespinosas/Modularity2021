...
void distancia_max(Alea &jacta, int timetocheck, int crittosat, int sample_nt, int nuic, int nodes, int *s, int *mgood, int *mbad, int **oc, int **ot, int modules, set<set<int>> &predpar, double *tomod, double *frommod, double wol, int veces_pasos, int *dists){
  ...
  for(int k = 0; k < sample_nt; k++){ 
      ...
      f_dist = false;
      paso = 1;
      bas.open_ifstream(muestra,  "muestrario/" + bas.inttostring(k) + "/" + "nw_2m.txt");
      ...
      while(!f_dist){
          do{
              ...
              f_cumple = lafi.cap_to_s(nodes, mgood, mbad, oc, ot, modules);
...
int main()
{
  ...
  double initial_mb = 0.1062;
  double initial_ma = 0.1983;
  double mues_sd = 0.04686;
  ...
  cap.start_all_ics(ats, nuic, modules, nodes);
  ...
  bas.create_array(tot_phen, 3, nuic);
  bas.create_array(tot_acphen, 3, nuic);
  
  double mean_frac_newpht, mean_frac_newacph;
  double *frac_newpht, *frac_newacph;
  frac_newpht = new double[nuic];
  frac_newacph = new double[nuic];
  ...
  tot_acphens = new int[nuic];
  acphens_d1 = new int[nuic];
  acphens_m1 = new int[nuic];
  acphens_multchan = new int[nuic];
  sim_acphens = new double[nuic];
  mods_acphens = new double[nuic];
  frac_acphens_d1 = new double[nuic];
  frac_acphens_m1 = new double[nuic];
  ...
  tot_newpht = new int[nuic];
  tot_newacph = new int[nuic];
  newpht_g1 = new int[nuic];
  newacph_g1 = new int[nuic];
  newpht_d1 = new int[nuic];
  newacph_d1 = new int[nuic];
  newpht_m1 = new int[nuic];
  newacph_m1 = new int[nuic];
  newpht_multchan = new int[nuic];
  newacph_multchan = new int[nuic];
  
  simnewpht = new double[nuic];
  simnewacph = new double[nuic];
  modsnewpht = new double[nuic];
  modsnewacph = new double[nuic];
  frac_newpht_g1 = new double[nuic];
  frac_newacph_g1 = new double[nuic];
  frac_newpht_d1 = new double[nuic];
  frac_newacph_d1 = new double[nuic];
  frac_newpht_m1 = new double[nuic];
  frac_newacph_m1 = new double[nuic];
  ...
  for(int l = 0; l < veces_k; l++){
    ...
    distancia_max(jacta, timetocheck, crittosat, sample_nt, nuic, nodes, s, mgood[0], mbad[0], oc[0], ot[0], modules, predpar, to, from, wol, veces_pasos, dists);
    
    for(int i = 0; i < inter_mod; i++){
        bas.open_ofstream(salida[i][0],  "distbtwnw/" + bas.inttostring(seed) + "_" + mods[i] + "_" + bas.inttostring(rep_nw) + "rep_general_2m.txt");
        ...
        bas.open_ofstream(salida[i][1],  "distbtwnw/" + bas.inttostring(seed) + "_" + mods[i] + "_" + bas.inttostring(rep_nw) + "rep_acphens_2m.txt");
        ...
        bas.open_ofstream(salida[i][2],  "distbtwnw/" + bas.inttostring(seed) + "_" + mods[i] + "_" + bas.inttostring(rep_nw) + "rep_newphen_2m.txt");
    ...
    for(int i = 0; i < sample_nt; i++){
        ...
        cout << cuint <<  " " << i << endl;
        bas.open_ifstream(muestra,  "muestrario/" + bas.inttostring(i) + "/" + "nw_2m.txt");
    ...
    //         cout << mod1 << endl;
        for(int j = 0; j < veces_pasos; j++){
            ...
            for(int nurep = 0; nurep < rep_nw; nurep++){
                bas.fillmat0(tot_phen, 3, nuic);
                bas.fillmat0(tot_acphen, 3, nuic);
                
                bas.fillv0(frac_newpht, nuic);
                bas.fillv0(frac_newacph, nuic);
                bas.fillv0(tot_acphens, nuic);
                bas.fillv0(sim_acphens, nuic);
                bas.fillv0(mods_acphens, nuic);
                bas.fillv0(acphens_d1, nuic);
                bas.fillv0(acphens_m1, nuic);
                bas.fillv0(acphens_multchan, nuic);
                bas.fillv0(frac_acphens_d1, nuic);
                bas.fillv0(frac_acphens_m1, nuic);
                
                bas.fillv0(tot_newpht, nuic);
                bas.fillv0(tot_newacph, nuic);
                bas.fillv0(newpht_g1, nuic);
                bas.fillv0(newpht_d1, nuic);
                bas.fillv0(simnewpht, nuic);
                bas.fillv0(simnewacph, nuic);
                bas.fillv0(modsnewpht, nuic);
                bas.fillv0(modsnewacph, nuic);
                bas.fillv0(newacph_g1, nuic);
                bas.fillv0(newacph_d1, nuic);
                bas.fillv0(newpht_m1, nuic);
                bas.fillv0(newacph_m1, nuic);
                bas.fillv0(newpht_multchan, nuic);
                bas.fillv0(newacph_multchan, nuic);
                
                bas.fillv0(frac_newpht_g1, nuic);
                bas.fillv0(frac_newacph_g1, nuic);
                bas.fillv0(frac_newpht_d1, nuic);
                bas.fillv0(frac_newacph_d1, nuic);
                bas.fillv0(frac_newpht_m1, nuic);
                bas.fillv0(frac_newacph_m1, nuic);
                ...
                do{
                    do{
                        ...
                        f_cumple = lafi.cap_to_s(nodes, mgood[1], mbad[1], oc[1], ot[1], modules);
                        redtemp.build_moma_d(matmod);
                        modtemp = redtemp.eval_mod(matmod, predpar);
                ...
                mean_tot_phen12 += bas.get_mean(tot_phen[2], nuic);
                mean_tot_phen1 += bas.get_mean(tot_phen[0], nuic);
                mean_tot_phen2 += bas.get_mean(tot_phen[1], nuic);
                mean_tot_acphen12 += bas.get_mean(tot_phen[2], nuic);
                mean_tot_acphen1 += bas.get_mean(tot_phen[0], nuic);
                mean_tot_acphen2 += bas.get_mean(tot_phen[1], nuic);
                mean_frac_newpht += bas.get_mean(frac_newpht, nuic);
                mean_frac_newacph += bas.get_mean(frac_newacph, nuic);
                mean_mod1 += mod1;
                mean_mod2 += mod2;
                ...
                mean_tot_acphens += bas.get_mean(tot_acphens, nuic);
                mean_sim_acphens += bas.get_mean(sim_acphens, nuic);
                mean_mods_acphens += bas.get_mean(mods_acphens, nuic);
                mean_acphens_d1 += bas.get_mean(acphens_d1, nuic);
                mean_acphens_m1 += bas.get_mean(acphens_m1, nuic);
                mean_frac_acphens_d1 += bas.get_mean(frac_acphens_d1, nuic);
                mean_frac_acphens_m1 += bas.get_mean(frac_acphens_m1, nuic);
                mean_acphens_multchan += bas.get_mean(acphens_multchan, nuic);
                ...
                mean_tot_newpht += bas.get_mean(tot_newpht, nuic);
                mean_simnewpht += bas.get_mean(simnewpht, nuic);
                mean_modsnewpht += bas.get_mean(modsnewpht, nuic);
                mean_newpht_g1 += bas.get_mean(newpht_g1, nuic);
                mean_newpht_d1 += bas.get_mean(newpht_d1, nuic);
                mean_newpht_m1 += bas.get_mean(newpht_m1, nuic);
                mean_frac_newpht_d1 += bas.get_mean(frac_newpht_d1, nuic);
                mean_frac_newpht_g1 += bas.get_mean(frac_newpht_g1, nuic);
                mean_frac_newpht_m1 += bas.get_mean(frac_newpht_m1, nuic);
                mean_newpht_multchan += bas.get_mean(newpht_multchan, nuic);
                
                mean_tot_newacph += bas.get_mean(tot_newacph, nuic);
                mean_simnewacph += bas.get_mean(simnewacph, nuic);
                mean_modsnewacph += bas.get_mean(modsnewacph, nuic);
                mean_newacph_g1 += bas.get_mean(newacph_g1, nuic);
                mean_newacph_d1 += bas.get_mean(newacph_d1, nuic);
                mean_newacph_m1 += bas.get_mean(newacph_m1, nuic);
                mean_frac_newacph_g1 += bas.get_mean(frac_newacph_g1, nuic);
                mean_frac_newacph_d1 += bas.get_mean(frac_newacph_d1, nuic);
                mean_frac_newacph_m1 += bas.get_mean(frac_newacph_m1, nuic);
                mean_newacph_multchan += bas.get_mean(newacph_multchan, nuic);
