...
//   Exporta los parametros de muestra
  ...
  bas.open_ifstream(cl_anc, directorio[0] + "/hist/" + bas.inttostring(seed) + "_data_2m.txt");
  count = 0;
  string header;
...
//   }
  ...
  ofstream mod_int;
  bas.open_ofstream(mod_int, "pars/"+bas.inttostring(seed)+"_mod_int_2m.txt");
