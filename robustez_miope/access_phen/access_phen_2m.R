...
Accphen <- read.table(paste0("access_phen/", seed, "_allmut_2m.txt"), header = TRUE, sep = "\t")
...
pdf(paste0("access_phen/Phen_tot_", seed, "_2m.pdf"),paper='special')
    grid.arrange(ptot_pht, psimpht, pmodspht, ppht_g1, ppht_d1, ppht_m1, pfrac_pht_g1, pfrac_pht_d1, pfrac_pht_m1)
dev.off()
...
pdf(paste0("access_phen/Acum_phen_", seed, "_2m.pdf"),paper='special')
    grid.arrange(ptot_acph, psimacph, pmodsacph, pacph_d1, pacph_m1, pfrac_acph_d1, pfrac_acph_m1)
dev.off()
...
pdf(paste0("access_phen/General_", seed, "_2m.pdf"),paper='special')
