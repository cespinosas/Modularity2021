...
int main()
{
  ...
  ofstream ocon;
  bas.open_ofstream(ocon, "miope_mod/" +  bas.inttostring(seed) + "_con_2m.txt");
  ocon << "Initial" << "\t" << "Final" << endl;
    
  ofstream omod;
  bas.open_ofstream(omod, "miope_mod/" + bas.inttostring(seed) + "_mod_2m.txt");
  omod << "Initial" << "\t" << "Final" << endl;
  
  ofstream orob;
  bas.open_ofstream(orob, "miope_mod/" + bas.inttostring(seed) + "_rob_2m.txt");
  orob << "Initial" << "\t" << "Final" << endl;
  
  ofstream otime;
  bas.open_ofstream(otime, "miope_mod/" + bas.inttostring(seed) + "_time_2m.txt");
